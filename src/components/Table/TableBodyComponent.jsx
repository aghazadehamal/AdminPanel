          ...
          <TableRow key={index}>
            <TableCell colSpan={6}>
              {isMobile ? (
                ...
                >
                  <Skeleton variant="text" width="50%" height={24} sx={{ margin: "0 auto" }} />
                  <Skeleton variant="rectangular" width="100%" height={80} sx={{ marginY: 1 }} />
                  <Skeleton variant="text" width="60%" height={24} sx={{ margin: "0 auto" }} />
                  <Skeleton variant="text" width="80%" height={24} sx={{ margin: "0 auto" }} />
                  <Skeleton variant="text" width="90%" height={24} sx={{ margin: "0 auto" }} />
                  <Box
                    sx={{
                      display: "flex",
            ...
            {isMobile ? (
              ...
              >
                ...
                <Typography variant="body2">
                  {truncateText(getTitleByLanguage(link.usefulLinksTranslations, languageId), 18)}
                </Typography>
